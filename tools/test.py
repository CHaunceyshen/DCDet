...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',
                        default='/media/yun/4t/work4t/scc/mmrotate/configs/oriented_rcnn/oriented_rcnn_r50_fpn_1x_dota_le90.py')
    parser.add_argument('--checkpoint', help='checkpoint file',
                       default='/media/yun/4t/work4t/scc/mmrotate/work_dirs/oriented_rcnn_11a/epoch_12.pth')
    parser.add_argument(
        '--work-dir',
