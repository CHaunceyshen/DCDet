...
from mmrotate.core import build_bbox_coder, multiclass_nms_rotated, rbbox_overlaps
from ...builder import ROTATED_HEADS, build_loss


@ROTATED_HEADS.register_module()
class RotatedCorrBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RotatedCorrBBoxHead, self).__init__(init_cfg)
